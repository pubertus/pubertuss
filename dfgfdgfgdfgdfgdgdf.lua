...
local library = {
    ...
    draggable = true,
    flags = {},
    title = "Pubertus | Executor: " .. identifyexecutor(),
    open = false,
    popup = nil,
    instances = {},
    connections = {},
...
function library:Init()
    ...
    self.glowStroke = self:Create("UIStroke", {
        Thickness = 4, 
    ...
    self.glowGradient = self:Create("UIGradient", {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)), 
